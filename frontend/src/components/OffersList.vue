...
<script>
    ...
    methods: {
      goToOffer(id, departure, date, adult, child18, child10, child3) {
        ...
        async fetchData() {
            const response = await fetch('http://localhost:8080/Offers/GetTrips?DestinationCity=' + this.$route.query.destination + '&OriginCity=' + this.$route.query.departure + '&DateStart=' + this.$route.query.date + '&PeopleNumber=' + (this.$route.query.adult + this.$route.query.child18 + this.$route.query.child10 + this.$route.query.child3));
