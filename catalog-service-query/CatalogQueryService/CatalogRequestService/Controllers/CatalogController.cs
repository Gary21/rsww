...
namespace CatalogQueryService.Controllers
{
    ...
    public class CatalogController : ControllerBase
    {
        ...
        public CatalogController(PublisherServiceBase catalogQueryPublisher, ConsumerServiceBase catalogQueryHandler)
        {
        ...
        public async Task<IEnumerable<TransportDTO>> Get(
            [FromQuery] List<string>? departureCityIds = null,
            [FromQuery] List<string>? arrivalCityIds = null,
            [FromQuery] List<string>? transportTypes = null,
            ...
            )
        {
            ...
            if (departureCityIds != null) { query.filters.CityOrigins = departureCityIds; }
            if (arrivalCityIds != null) { query.filters.CityDestinations = arrivalCityIds; }
            if (transportTypes != null) { query.filters.Types = transportTypes; }
            if (numberOfPassengers != null) { query.filters.AvailableSeats = numberOfPassengers; }
